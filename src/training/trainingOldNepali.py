...
training_args = Seq2SeqTrainingArguments(
    output_dir="./trocr-nagari-oldNepalinew-finetune-4e",
...
trainer.train()
trainer.save_model("./trocr-nagari-oldNepalinew-finetune-4e")
processor.save_pretrained("./trocr-nagari-oldNepalinew-finetune-4e")
