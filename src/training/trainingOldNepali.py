...
dataset = load_dataset("json", data_files={"train": "oldNepaliDataCombined/labels.json"})
...
training_args = Seq2SeqTrainingArguments(
    output_dir="./trocr-nagari-IIT_HW-oldNepalinew-finetune",
...
trainer.train()
trainer.save_model("./trocr-nagari-IIT_HW-oldNepalinew-finetune")
processor.save_pretrained("./trocr-nagari-IIT_HW-oldNepalinew-finetune")
...
# trocr-nagari-IIT_HW-oldNepalinew-finetune : 15 epochs, 3e-5 lr -- new + iit_hw